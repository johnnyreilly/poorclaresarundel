describe("Controllers ->", function () {
    ...
    describe("PrayerRequestController ->", function () {
        ...
        var prayerRequestController: poorClaresApp.controllers.PrayerRequestController,
            prayerRequestService: IPrayerRequestService,
            $rootScope: angular.IRootScopeService,
            $scope: angular.IScope,
            deferred: angular.IDeferred<{ success: boolean; text: string; }>,
            prayerRequest;

        beforeEach(inject(function (_$rootScope_, $q: angular.IQService, _$controller_, _prayerRequestService_) {
